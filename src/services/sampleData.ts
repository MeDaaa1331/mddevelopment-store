...
<p>Fully optimized with <strong>0.00ms idle resmon</strong>. Includes automated Discord webhook transaction logging.</p>`,
    ...
    image: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&w=1920&q=95&fm=webp",
    screenshots: [
      "https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?auto=format&fit=crop&w=1920&q=95&fm=webp"
    ],
    is_featured: true,
    is_bestseller: true,
...
<p>Supports custom addon vehicles with zero configuration needed. 0.00ms resmon.</p>`,
    ...
    resmon: "0.00ms",
    youtube_id: "dQw4w9WgXcQ",
    image: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1920&q=95&fm=webp",
    screenshots: [
      "https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1542282088-72c9c27ed0cd?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=1920&q=95&fm=webp"
    ],
    is_featured: true,
    is_bestseller: true,
    is_open_source: false,
...
<p>Plug and play for ESX and QBCore servers.</p>`,
    ...
    resmon: "0.00ms",
    youtube_id: "dQw4w9WgXcQ",
    image: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1920&q=95&fm=webp",
    screenshots: [
      "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1530595467537-0b5996c41f2d?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1603909223429-69bb7101f420?auto=format&fit=crop&w=1920&q=95&fm=webp"
    ],
    is_featured: true,
    is_new: true,
    is_open_source: false,
...
<ul>
  ...
  <li><strong>Lockpicking & Police Breaching:</strong> Criminals can lockpick rooms, and police can issue raid warrants.</li>
    ...
    resmon: "0.00ms",
    youtube_id: "dQw4w9WgXcQ",
    image: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=1920&q=95&fm=webp",
    screenshots: [
      "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1590490360182-c33d57733427?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1566665797739-1674de7a421a?auto=format&fit=crop&w=1920&q=95&fm=webp"
    ],
    is_featured: false,
    is_new: true,
    is_open_source: false,
...
<ul>
  ...
  <li><strong>Company Upgrades:</strong> Unlock faster trucks, refrigerated cargo, and hazardous material permits.</li>
    ...
    resmon: "0.00ms",
    youtube_id: "dQw4w9WgXcQ",
    image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=1920&q=95&fm=webp",
    screenshots: [
      "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?auto=format&fit=crop&w=1920&q=95&fm=webp"
    ],
    is_featured: false,
    is_bestseller: false,
    is_open_source: false,
...
<ul>
  ...
  <li><strong>All Future Updates Included:</strong> Free lifetime updates directly via Keymaster.</li>
    ...
    resmon: "0.01ms total",
    youtube_id: "dQw4w9WgXcQ",
    image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=1920&q=95&fm=webp",
    screenshots: [
      "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1920&q=95&fm=webp",
      "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1920&q=95&fm=webp"
    ],
...
<ul>
  ...
  <li><strong>Custom Database Migrations:</strong> Clean SQL schemas for custom core integrations.</li>
    ...
    resmon: "0.00ms",
    youtube_id: "dQw4w9WgXcQ",
    image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1920&q=95&fm=webp",
    is_featured: true,
    is_open_source: true,
    features: [
...
<p>Fully unencrypted and open source release of MD Vehicleshop 2.0. Perfect for developer teams looking to add custom vehicle financing logic, dealership exports, or custom web integrations.</p>`,
    ...
    resmon: "0.00ms",
    youtube_id: "dQw4w9WgXcQ",
    image: "https://images.unsplash.com/photo-1542282088-72c9c27ed0cd?auto=format&fit=crop&w=1920&q=95&fm=webp",
    is_featured: false,
    is_open_source: true,
    features: [
...
<p>Exclusive free download for verified MD Development Discord members.</p>`,
    ...
    frameworks: ['ESX', 'QB'],
    resmon: "0.00ms",
    image: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=1920&q=95&fm=webp",
    is_featured: false,
    is_open_source: true,
    is_free: true,
...
<p>Clean, high-performance Discord webhook audit logger for player connections, admin commands, item drops, death kills, money transactions, and vehicle spawns with rich embed colors and steam avatar integration.</p>`,
    ...
    frameworks: ['ESX', 'QB'],
    resmon: "0.00ms",
    image: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=1920&q=95&fm=webp",
    is_featured: false,
    is_open_source: true,
    is_free: true,
    download_url: "https://github.com/MeDaaa1331/mddevelopment-store/archive/refs/heads/main.zip",
